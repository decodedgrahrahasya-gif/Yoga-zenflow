...
export const metadata = {
  title: "Contact — ZenFlow Yoga",
  description: "Get in touch with the ZenFlow team.",
}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div>
          ...
          <p className="text-[#64746B] text-sm max-w-md mb-12">
            Whether you need help choosing a program, or have questions about
            our methodology, our concierge team is here to guide you.
          </p>
        ...
        <div className="bg-white p-8 md:p-10 border border-[#0A3B2C]/10 shadow-sm">
          <form className="space-y-8">
            ...
            <div className="space-y-2 text-left">
              ...
              <textarea id="message" rows={4} className="w-full bg-transparent border-b border-[#0A3B2C]/20 py-2 text-sm text-[#1A2520] focus:outline-none focus:border-[#C5A059] transition-colors placeholder:text-[#64746B]/40 resize-none" placeholder="Tell us more about your practice..." />
            </div>
            <div className="pt-4">
