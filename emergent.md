...
<html lang=\"en\">
    <head>
        ...
        <meta name=\"description\" content=\"ZenFlow Yoga — A premium AI-powered yoga & wellness platform for physical, mental and emotional balance.\" />
        <link rel=\"preconnect\" href=\"https://fonts.googleapis.com\" />
        <link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin />
        <link href=\"https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,400&family=Outfit:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap\" rel=\"stylesheet\" />
        <title>ZenFlow Yoga — Find your flow. Live your light.</title>
    ...
    <body>
        ...
        >
            ...
            <p style=\"color: #FFF !important; font-family: 'Outfit', sans-serif !important; font-size: 13px !important; font-weight: 600 !important; margin: 0 !important; white-space: nowrap !important;\">Made with Emergent</p>
        </a>
        <script>
            !(function (t, e) {
                var o, n, p, r;
...
:root {
    ...
    --zf-ivory-alt: #F5F2EB;
    --zf-emerald: #0A3B2C;
    --zf-emerald-hover: #072A1F;
    --zf-gold: #C5A059;
    --zf-gold-hover: #B38F46;
    --zf-text: #1A2520;
    --zf-text-muted: #64746B;
    --zf-border: rgba(10, 59, 44, 0.15);
}

html, body, #root {
    background-color: var(--zf-ivory);
    color: var(--zf-text);
}
...
.zf-rise {
    animation: zf-rise 0.9s cubic-bezier(0.22, 1, 0.36, 1) both;
}
...
.zf-fade {
    animation: zf-fade 1.4s ease-out both;
}
...
.zf-gold-line {
    background: linear-gradient(90deg, transparent, var(--zf-gold), transparent);
    background-size: 200% 100%;
    animation: zf-shimmer 6s linear infinite;
}
...
@layer base {
    :root {
        ...
        --secondary: 42 31% 94%;
        --secondary-foreground: 154 70% 14%;
        --muted: 42 31% 94%;
        --muted-foreground: 150 8% 43%;
        --accent: 40 47% 56%;
        --accent-foreground: 154 70% 14%;
        --destructive: 0 70% 45%;
